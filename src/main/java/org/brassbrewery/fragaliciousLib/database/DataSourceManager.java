package org.brassbrewery.fragaliciousLib.database;
...
public abstract class DataSourceManager {
    ...
    public DataSource getSqlLiteDataSource() {
        ...
        config.setPoolName("Fragalicious-SQLite-Pool");

        return new com.zaxxer.hikari.HikariDataSource(config);
    }

    public abstract void initalizeMySqlDatabase();
    public abstract void initializeSQLiteDatabase();
