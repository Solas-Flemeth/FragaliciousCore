package org.brassbrewery.fragaliciousLib.util;
...
public class SerializationUtils {
    ...
    @SuppressWarnings("unchecked") // This should return a map always due to the input being serialized from a hashmap
